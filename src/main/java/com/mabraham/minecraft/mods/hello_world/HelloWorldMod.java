...
public final class HelloWorldMod
{
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        // In actual fact, this example here sends a "Hello world" to itself
        InterModComms.sendTo("hello_world_mod", "helloworld", () -> {
            log.info("Hello world from the MDK"); return "Hello world";
        });
    }
